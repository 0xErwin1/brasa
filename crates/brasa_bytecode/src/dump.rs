...
fn render_op(module: &Module, op: &Op) -> (String, Option<String>) {
    ...
    match *op {
        ...
        Op::EqInt => ("eq_int".to_string(), None),
        Op::EqFloat => ("eq_float".to_string(), None),
        Op::EqBool => ("eq_bool".to_string(), None),
        Op::LtInt => ("lt_int".to_string(), None),
        Op::LeInt => ("le_int".to_string(), None),
        Op::GtInt => ("gt_int".to_string(), None),
        Op::GeInt => ("ge_int".to_string(), None),
        Op::LtFloat => ("lt_float".to_string(), None),
        Op::LeFloat => ("le_float".to_string(), None),
        Op::GtFloat => ("gt_float".to_string(), None),
        Op::GeFloat => ("ge_float".to_string(), None),
